...
public class ${JavaModName}Items {
	...
	private static <I extends Item> RegistryObject<I> register(String name, Function<Item.Properties, ? extends I> supplier) {
		return REGISTRY.register(name, () -> supplier.apply(new Item.Properties().setId(REGISTRY.key(name))));
	}

	private static <I extends Item> RegistryObject<I> register(String name, Function<Item.Properties, ? extends I> supplier, Item.Properties properties) {
		return REGISTRY.register(name, () -> supplier.apply(properties.setId(REGISTRY.key(name))));
	}
	...
	private static RegistryObject<Item> block(RegistryObject<Block> block, Item.Properties properties) {
		return register(block.getId().getPath(), prop -> new BlockItem(block.get(), prop), properties);
	}
	</#if>
	...
	private static RegistryObject<Item> doubleBlock(RegistryObject<Block> block, Item.Properties properties) {
		return register(block.getId().getPath(), prop -> new DoubleHighBlockItem(block.get(), prop), properties);
	}
	</#if>
	...
	@Mod.EventBusSubscriber(value = Dist.CLIENT) public static class ItemsClientSideHandler {
