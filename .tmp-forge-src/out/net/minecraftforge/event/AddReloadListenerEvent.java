...
public final class AddReloadListenerEvent extends MutableEvent {
    ...
    */
    ...
    private record WrappedStateAwareListener(PreparableReloadListener wrapped) implements PreparableReloadListener {
        ...
        @Override
        public CompletableFuture<Void> m_5540_(final PreparationBarrier stage, final ResourceManager resourceManager, final Executor backgroundExecutor, final Executor gameExecutor) {
            if (ModLoader.isLoadingStateValid())
                return wrapped.m_5540_(stage, resourceManager, backgroundExecutor, gameExecutor);
            else
