...
public record CustomPayloadEvent(
    ...
    public static class Context {
        ...
        public Context(Connection connection) {
            ...
            this.client = connection.m_178313_() == PacketFlow.CLIENTBOUND;
        }
        ...
        public CompletableFuture<Void> enqueueWork(Runnable runnable) {
            ...
            if (!executor.m_18695_())
                return executor.m_18689_(runnable); // Use the internal method so thread check isn't done twice
            else {
                runnable.run();
        ...
        public ServerPlayer getSender() {
            PacketListener netHandler = connection.m_129538_();
