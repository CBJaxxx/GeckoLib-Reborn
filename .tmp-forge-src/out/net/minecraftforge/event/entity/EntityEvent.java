...
public class EntityEvent extends MutableEvent implements InheritableEvent {
    ...
    public static final class EnteringSection extends EntityEvent {
        ...
        public SectionPos getOldPos() {
            return SectionPos.m_123184_(packedOldPos);
        }
        ...
        public SectionPos getNewPos() {
            return SectionPos.m_123184_(packedNewPos);
        }
        ...
        public boolean didChunkChange() {
            return SectionPos.m_123213_(packedOldPos) != SectionPos.m_123213_(packedNewPos) || SectionPos.m_123230_(packedOldPos) != SectionPos.m_123230_(packedNewPos);
        }
    }
}
