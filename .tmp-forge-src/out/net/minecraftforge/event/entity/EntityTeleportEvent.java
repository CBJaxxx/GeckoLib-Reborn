...
public sealed class EntityTeleportEvent extends EntityEvent implements Cancellable {
    ...
    public double getPrevX() { return getEntity().m_20185_(); }
    public double getPrevY() { return getEntity().m_20186_(); }
    public double getPrevZ() { return getEntity().m_20189_(); }
    public Vec3 getPrev() { return getEntity().m_20182_(); }
