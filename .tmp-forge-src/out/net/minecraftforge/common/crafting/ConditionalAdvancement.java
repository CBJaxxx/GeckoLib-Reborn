...
public class ConditionalAdvancement {
    ...
    public static class Builder {
        private static final ResourceLocation DOESNT_MATTER = ResourceLocation.m_339182_("doesnt", "matter");
        ...
        public Builder advancement(AdvancementHolder holder) {
            return advancement(holder.f_290952_());
        }
        ...
        public JsonObject build(HolderLookup.Provider lookup) {
            ...
            var ops = lookup.m_318927_(JsonOps.INSTANCE);
            ...
            for (var pair : advancements) {
                ...
                if (pair.json != null)
                    ...
                    holder = (JsonObject)Advancement.f_303179_.encodeStart(ops, pair.adv()).getOrThrow(IllegalStateException::new);
