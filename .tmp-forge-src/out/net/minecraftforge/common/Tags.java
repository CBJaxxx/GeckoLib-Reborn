...
public class Tags {
    ...
    public static class Blocks {
        ...
        private static TagKey<Block> cTag(String name) {
            return BlockTags.create(ResourceLocation.m_339182_("c", name));
        }

        private static TagKey<Block> forgeTag(String name) {
            return BlockTags.create(ResourceLocation.m_339182_("forge", name));
        }
    }
    ...
    public static class EntityTypes {
        ...
        private static TagKey<EntityType<?>> cTag(String name) {
            return TagKey.m_203882_(Registries.f_256939_, ResourceLocation.m_339182_("c", name));
        }
    }
    ...
    public static class Items {
        ...
        private static TagKey<Item> cTag(String name) {
            return ItemTags.create(ResourceLocation.m_339182_("c", name));
        }

        private static TagKey<Item> forgeTag(String name) {
            return ItemTags.create(ResourceLocation.m_339182_("forge", name));
        }
    }
    ...
    public static class Fluids {
        ...
        private static TagKey<Fluid> cTag(String name) {
            return FluidTags.create(ResourceLocation.m_339182_("c", name));
        }

        private static TagKey<Fluid> forgeTag(String name) {
            return FluidTags.create(ResourceLocation.m_339182_("forge", name));
        }
    }
    ...
    public static class Enchantments {
        ...
        private static TagKey<Enchantment> cTag(String name) {
            return TagKey.m_203882_(Registries.f_256762_, ResourceLocation.m_339182_("c", name));
        }
    }
    ...
    public static class Biomes {
        ...
        private static TagKey<Biome> cTag(String name) {
            return TagKey.m_203882_(Registries.f_256952_, ResourceLocation.m_339182_("c", name));
        }

        private static TagKey<Biome> forgeTag(String name) {
            return TagKey.m_203882_(Registries.f_256952_, ResourceLocation.m_339182_("forge", name));
        }
    }
    ...
    public static class Structures {
        ...
        private static TagKey<Structure> cTag(String name) {
            return TagKey.m_203882_(Registries.f_256944_, ResourceLocation.m_339182_("c", name));
        }
    }
}
