...
public final class TransformationHelper
{
    ...
    public static Quaternionf slerp(Quaternionfc v0, Quaternionfc v1, float t)
    {
        ...
        if (dot > THRESHOLD) {
            float x = Mth.m_14179_(t, v0.x(), v1.x());
            float y = Mth.m_14179_(t, v0.y(), v1.y());
            float z = Mth.m_14179_(t, v0.z(), v1.z());
            float w = Mth.m_14179_(t, v0.w(), v1.w());
        ...
        float sin0t = Mth.m_14031_(angle0t);
        float sin01 = Mth.m_14031_(angle01);
        float sin1t = Mth.m_14031_(angle01 - angle0t);
    ...
    public static Transformation slerp(Transformation one, Transformation that, float progress)
    {
        return new Transformation(
            lerp(one.m_252829_(), that.m_252829_(), progress),
            slerp(one.m_253244_(), that.m_253244_(), progress),
            lerp(one.m_252900_(), that.m_252900_(), progress),
            slerp(one.m_252848_(), that.m_252848_(), progress)
        );
    }

    public static boolean epsilonEquals(Vector4f v1, Vector4f v2, float epsilon)
    {
        return Mth.m_14154_(v1.x()-v2.x()) < epsilon &&
               Mth.m_14154_(v1.y()-v2.y()) < epsilon &&
               Mth.m_14154_(v1.z()-v2.z()) < epsilon &&
               Mth.m_14154_(v1.w()-v2.w()) < epsilon;
    }
        ...
        public static Quaternionf parseAxisRotation(JsonElement e)
        {
            ...
            try
            {
                ret = switch (entry.getKey()) {
                    case "x" -> Axis.f_252529_.m_252977_(entry.getValue().getAsNumber().floatValue());
                    case "y" -> Axis.f_252436_.m_252977_(entry.getValue().getAsNumber().floatValue());
                    case "z" -> Axis.f_252403_.m_252977_(entry.getValue().getAsNumber().floatValue());
