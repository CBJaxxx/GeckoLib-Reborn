        ...
        if (entity.getClass() == ItemEntity.class) {
            ...
            if (item.hasCustomEntity(stack)) {
                ...
                if (newEntity != null) {
                    ...
                    var executor = LogicalSidedProvider.WORKQUEUE.get(event.getLevel().f_46443_ ? LogicalSide.CLIENT : LogicalSide.SERVER);
                    executor.m_18711_(new TickTask(0, () -> event.getLevel().m_7967_(newEntity)));
                    return true;
                }
            }
        }
