    ...
    protected void spriteSet(ParticleType<?> type, ResourceLocation baseName, int numOfTextures, boolean reverse) {
        ...
        this.spriteSet(type, () -> new Iterator<>() {
            ...
            public ResourceLocation next() {
                var texture = baseName.m_266382_("_" + (reverse ? numOfTextures - this.counter - 1 : this.counter));
                this.counter++;
                return texture;
            }
        });
    ...
    public CompletableFuture<?> m_213708_(CachedOutput cache) {
        ...
        return CompletableFuture.allOf(
                this.descriptions.entrySet().stream().map(entry -> {
                    ...
                    return DataProvider.m_253162_(cache,
                            Util.m_137469_(new JsonObject(), obj -> obj.add("textures", textures)),
                            this.particlesPath.m_245731_(entry.getKey())
                    );
