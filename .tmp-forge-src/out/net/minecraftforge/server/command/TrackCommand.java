                ...
                .then(Commands.m_82127_("te")
                    .then(Commands.m_82129_("duration", IntegerArgumentType.integer(1))
                        .executes(ctx -> {
                            ...
                            ctx.getSource().m_288197_(() -> Component.m_237110_("commands.forge.tracking.be.enabled", duration), true);
                            return 0;
                        })
                    )
                )
                .then(Commands.m_82127_("entity")
                    .then(Commands.m_82129_("duration", IntegerArgumentType.integer(1))
                        .executes(ctx -> {
                            ...
                            ctx.getSource().m_288197_(() -> Component.m_237110_("commands.forge.tracking.entity.enabled", duration), true);
                            return 0;
                        })
                    )
                );
        ...
        static ArgumentBuilder<CommandSourceStack, ?> register() {
            return Commands.m_82127_("reset")
                ...
                .then(Commands.m_82127_("te")
                    .executes(ctx -> {
                        TimeTracker.BLOCK_ENTITY_UPDATE.reset();
                        ctx.getSource().m_288197_(() -> Component.m_237115_("commands.forge.tracking.be.reset"), true);
                        return 0;
                    })
                )
                .then(Commands.m_82127_("entity")
                    .executes(ctx -> {
                        TimeTracker.ENTITY_UPDATE.reset();
                        ctx.getSource().m_288197_(() -> Component.m_237115_("commands.forge.tracking.entity.reset"), true);
                        return 0;
                    })
                );
        }
    ...
    private static class TrackResults {
        ...
        private static <T> int execute(CommandSourceStack source, TimeTracker<T> tracker, Function<ForgeTimings<T>, Component> toString) {
            ...
            if (timingsList.isEmpty())
                source.m_288197_(() -> Component.m_237115_("commands.forge.tracking.no_data"), true);
            else {
                timingsList.stream()
                    .filter(timings -> timings.getObject().get() != null)
                    .limit(10)
                    .forEach(timings -> source.m_288197_(() -> toString.apply(timings), true));
            }
            return 0;
        }
    }
    ...
    private static class TrackResultsEntity {
        static ArgumentBuilder<CommandSourceStack, ?> register() {
            return Commands.m_82127_("entity").executes(ctx -> TrackResults.execute(ctx.getSource(), TimeTracker.ENTITY_UPDATE, data -> {
                ...
                if (entity == null)
                    return Component.m_237115_("commands.forge.tracking.invalid");
                ...
                return Component.m_237110_("commands.forge.tracking.timing_entry", ForgeRegistries.ENTITY_TYPES.getKey(entity.m_6095_()), entity.m_9236_().m_46472_().m_135782_().toString(), pos.m_123341_(), pos.m_123342_(), pos.m_123343_(), tickTime);
            }));
        }
    }
    ...
    private static class TrackResultsBlockEntity {
        static ArgumentBuilder<CommandSourceStack, ?> register() {
            return Commands.m_82127_("te").executes(ctx -> TrackResults.execute(ctx.getSource(), TimeTracker.BLOCK_ENTITY_UPDATE, data -> {
                ...
                double averageTimings = data.getAverageTimings();
                String tickTime = (averageTimings > 1000 ? TIME_FORMAT.format(averageTimings / 1000) : TIME_FORMAT.format(averageTimings)) + (averageTimings < 1000 ? "\u03bcs" : "ms");
                return Component.m_237110_("commands.forge.tracking.timing_entry", ForgeRegistries.BLOCK_ENTITY_TYPES.getKey(be.m_58903_()), be.m_58904_().m_46472_().m_135782_().toString(), pos.m_123341_(), pos.m_123342_(), pos.m_123343_(), tickTime);
            }));
        }
    }
}
