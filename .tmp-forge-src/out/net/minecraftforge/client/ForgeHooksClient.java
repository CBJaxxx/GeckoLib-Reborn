...
public class ForgeHooksClient {
    ...
    public static void pushGuiLayer(Minecraft minecraft, Screen screen) {
        ...
        minecraft.m_240477_().m_404298_(screen.m_142562_());
    }
    ...
    public static void popGuiLayer(Minecraft minecraft) {
        ...
        popGuiLayerInternal(minecraft);
        if (minecraft.f_91080_ != null)
            minecraft.m_240477_().m_404298_(minecraft.f_91080_.m_142562_());
    }
    ...
    */
    ...
    public static Vector4f setupFog(FogType type, Camera camera, DeltaTracker delta, FogData data, Vector4f color) {
        ...
        if (camera.m_90583_().f_82480_ < (double)((float)camera.m_90588_().m_123342_() + state.m_76155_(camera.m_90592_().m_9236_(), camera.m_90588_())))
            IClientFluidTypeExtensions.of(state).modifyFogRender(camera, type, delta.m_338557_(), data, color);

        ViewportEvent.RenderFog.BUS.post(new ViewportEvent.RenderFog(type, camera, delta.m_338557_(), data, color));
        return color;
    }
    ...
    public static void onCustomizeChatEvent(GuiGraphics guiGraphics, ChatComponent chat, Window window, int mouseX, int mouseY, int tickCount) {
        ...
        guiGraphics.m_280168_().translate(evt.getPosX(), (float) ((evt.getPosY() - chat.m_93814_() + 40) / chat.m_93815_()));
    ...
    public static void drawForgePingInfo(JoinMultiplayerScreen gui, ServerData target, GuiGraphics guiGraphics, int x, int y, int width, int relativeMouseX, int relativeMouseY) {
        ...
        guiGraphics.m_280312_(RenderPipelines.f_379833_, ICON_SHEET, x + width - 18, y + 10, 16, 16, 0, idx, 16, 16, 256, 256);
        ...
        if(relativeMouseX > width - 15 && relativeMouseX < width && relativeMouseY > 10 && relativeMouseY < 26) {
            ...
            guiGraphics.m_402638_(Lists.transform(lines, Component::m_7532_), relativeMouseX + x, relativeMouseY + y);
        }
    }
    ...
    public static boolean isBlockInSolidLayer(BlockState state) {
        ...
        return model.getRenderTypes(state, RandomSource.m_216327_(), ModelData.EMPTY).contains(ChunkSectionLayer.SOLID);
    }
    ...
    public static @Nullable UnbakedGeometry deserializeBlockModelGeometry(JsonObject json, JsonDeserializationContext context) {
        var name = GsonHelper.m_13851_(json, "loader", null);
        if (name == null)
            return null;

        var loader = GeometryLoaderManager.get(ResourceLocation.m_338530_(name));
        if (loader == null)
    ...
    public static ForgeBlockModelData deserializeBlockModel(JsonObject json, JsonDeserializationContext context) {
        ...
        var transform = Optional.ofNullable(GsonHelper.m_13845_(json, "transform", null, context, Transformation.class));

        var renderTypeName = GsonHelper.m_13851_(json, "render_type", null);
        if (renderTypeName != null)
            renderType = Optional.of(ResourceLocation.m_338530_(renderTypeName));

        var renderTypeFastName = GsonHelper.m_13851_(json, "render_type_fast", null);
        if (renderTypeFastName != null)
            renderTypeFast = Optional.of(ResourceLocation.m_338530_(renderTypeFastName));

        var visibilityJson = GsonHelper.m_13841_(json, "visibility", null);
    ...
    private record WrapedModelBaker(ModelBaker parent, RenderTypeGroup group, RenderTypeGroup renderTypeFast) implements ModelBaker {
        ...
        @Override public ResolvedModel m_247217_(ResourceLocation p_397309_) {
            return parent.m_247217_(p_397309_);
        }
        ...
        @Override
        public <T> T m_383903_(SharedOperationKey<T> p_395456_) {
            return parent.m_383903_(p_395456_);
        }
    }
