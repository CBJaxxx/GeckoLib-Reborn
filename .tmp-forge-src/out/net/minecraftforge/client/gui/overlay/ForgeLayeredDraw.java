...
public final class ForgeLayeredDraw implements ForgeLayer {
    ...
    public static final ResourceLocation  PRE_SLEEP_STACK = ResourceLocation.m_340282_("pre_sleep_phase");
    public static final ResourceLocation   CAMERA_OVERLAY = ResourceLocation.m_340282_("camera_overlay");
    public static final ResourceLocation        CROSSHAIR = ResourceLocation.m_340282_("crosshair");
    public static final ResourceLocation   CHANGE_STRATUM = ResourceLocation.m_340282_("stratum_change");
    public static final ResourceLocation HOTBAR_AND_DECOS = ResourceLocation.m_340282_("hotbar");
    public static final ResourceLocation   POTION_EFFECTS = ResourceLocation.m_340282_("potion_effects");
    public static final ResourceLocation     BOSS_OVERLAY = ResourceLocation.m_340282_("boss_overlay");

    public static final ResourceLocation POST_SLEEP_STACK = ResourceLocation.m_340282_("post_sleep_phase");
    public static final ResourceLocation     DEMO_OVERLAY = ResourceLocation.m_340282_("demo");
    public static final ResourceLocation    DEBUG_OVERLAY = ResourceLocation.m_340282_("debug");
    public static final ResourceLocation       SCOREBOARD = ResourceLocation.m_340282_("scoreboard");
    public static final ResourceLocation   HOTBAR_MESSAGE = ResourceLocation.m_340282_("hotbar_message");
    public static final ResourceLocation    TITLE_OVERLAY = ResourceLocation.m_340282_("title");
    public static final ResourceLocation     CHAT_OVERLAY = ResourceLocation.m_340282_("chat_overlay");
    public static final ResourceLocation         TAB_LIST = ResourceLocation.m_340282_("tab_list");
    public static final ResourceLocation SUBTITLE_OVERLAY = ResourceLocation.m_340282_("subtitle");

    public static final ResourceLocation     VANILLA_ROOT = ResourceLocation.m_340282_("vanilla_root");
    public static final ResourceLocation    SLEEP_OVERLAY = ResourceLocation.m_340282_("sleep_overlay");
    ...
    public static void init(Gui gui, Minecraft minecraft) {
        var preSleepDraw = new ForgeLayeredDraw(PRE_SLEEP_STACK)
            .add(CAMERA_OVERLAY, gui::m_318727_)
            .add(CROSSHAIR, gui::m_280130_)
            .add(CHANGE_STRATUM, (gg, dt) -> gg.m_402297_())
            .add(HOTBAR_AND_DECOS, gui::m_319215_)
            .add(POTION_EFFECTS, gui::m_280523_)
            .add(BOSS_OVERLAY, gui::m_401964_);
        var postSleepDraw = new ForgeLayeredDraw(POST_SLEEP_STACK)
            .add(DEMO_OVERLAY, gui::m_280339_)
            .add(DEBUG_OVERLAY, gui::m_402696_)
            .add(SCOREBOARD, gui::m_323286_)
            .add(HOTBAR_MESSAGE, gui::m_324281_)
            .add(TITLE_OVERLAY, gui::m_320668_)
            .add(CHAT_OVERLAY, gui::m_322096_)
            .add(TAB_LIST, gui::m_320053_)
            .add(SUBTITLE_OVERLAY, gui::m_403250_);
        instance
            .add(PRE_SLEEP_STACK, preSleepDraw, () -> !minecraft.f_91066_.f_92062_)
            .add(SLEEP_OVERLAY, gui::m_322680_)
            .add(POST_SLEEP_STACK, postSleepDraw, () -> !minecraft.f_91066_.f_92062_);
