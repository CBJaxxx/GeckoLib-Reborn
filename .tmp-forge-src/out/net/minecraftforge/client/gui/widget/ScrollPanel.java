...
public abstract class ScrollPanel extends AbstractContainerEventHandler implements Renderable, NarratableEntry {
    ...
    public void m_88315_(GuiGraphics guiGraphics, int mouseX, int mouseY, float partialTick) {
        ...
        if (extraHeight > 0) {
            ...
            guiGraphics.m_280509_(barLeft, this.top, barLeft + barWidth, this.bottom, barBgColor);
            guiGraphics.m_280509_(barLeft, barTop, barLeft + barWidth, barTop + barHeight, barColor);
            guiGraphics.m_280509_(barLeft, barTop + barHeight - 1, barLeft + barWidth - 1, barTop, barBorderColor);
            /*
