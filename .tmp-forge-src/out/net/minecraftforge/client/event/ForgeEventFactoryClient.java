...
public final class ForgeEventFactoryClient {
    ...
    public static boolean onScreenMouseReleased(Screen screen, double mouseX, double mouseY, int button) {
        ...
        var ret = screen.m_6348_(mouseX, mouseY, button);
    ...
    public static boolean onScreenMouseClicked(Screen screen, double mouseX, double mouseY, int button) {
        ...
        if (!ret)
            ret = screen.m_6375_(mouseX, mouseY, button);
    ...
    public static boolean onMouseScroll(MouseHandler mouseHelper, double deltaX, double deltaY) {
        return InputEvent.MouseScrollingEvent.BUS.post(new InputEvent.MouseScrollingEvent(deltaX, deltaY, mouseHelper.m_91560_(), mouseHelper.m_168090_(), mouseHelper.m_91584_(), mouseHelper.m_91589_(), mouseHelper.m_91594_()));
    }
    ...
    public static void firePlayerLogout(@Nullable MultiPlayerGameMode pc, @Nullable LocalPlayer player) {
        ClientPlayerNetworkEvent.LoggingOut.BUS.post(new ClientPlayerNetworkEvent.LoggingOut(pc, player, player != null ? player.f_108617_ != null ? player.f_108617_.m_104910_() : null : null));
    }
    ...
    public static ViewportEvent.ComputeCameraAngles fireComputeCameraAngles(GameRenderer renderer, Camera camera, float partial) {
        return ViewportEvent.ComputeCameraAngles.BUS.fire(new ViewportEvent.ComputeCameraAngles(renderer, camera, partial, camera.m_90590_(), camera.m_90589_(), 0));
    }
