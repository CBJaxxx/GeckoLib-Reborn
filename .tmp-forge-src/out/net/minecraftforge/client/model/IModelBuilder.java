...
public interface IModelBuilder<T extends IModelBuilder<T>> {
    ...
    class Collecting implements IModelBuilder<Collecting> {
        private static final BlockModelPart EMPTY = new SimpleModelWrapper(QuadCollection.f_382342_, false, new TextureAtlasSprite(ResourceLocation.m_339182_("forge", "empty"), null, 0, 0, 0, 0) {});
