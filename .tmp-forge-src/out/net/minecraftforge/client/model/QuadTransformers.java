...
public final class QuadTransformers {
    ...
    private static final IQuadTransformer[] EMISSIVE_TRANSFORMERS = Util.m_137469_(new IQuadTransformer[16], array -> {
        Arrays.setAll(array, i -> applyingLightmap(LightTexture.m_109885_(i, i)));
    });
    ...
    public static IQuadTransformer applying(Transformation transform) {
        ...
        return quad -> {
            var vertices = Arrays.copyOf(quad.f_111292_(), quad.f_111292_().length);
            for (int i = 0; i < 4; i++) {
            ...
            return new BakedQuad(vertices, quad.f_111293_(), quad.f_111294_(), quad.f_111295_(), quad.f_111296_(), quad.f_346614_(), quad.ambientOcclusion());
        };
    }
    ...
    public static IQuadTransformer applyingLightmap(int blockLight, int skyLight) {
        return applyingLightmap(LightTexture.m_109885_(blockLight, skyLight));
    }
