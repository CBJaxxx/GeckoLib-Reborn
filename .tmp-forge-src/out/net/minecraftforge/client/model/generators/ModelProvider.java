...
public abstract class ModelProvider<T extends ModelBuilder<T>> implements DataProvider {
    ...
    public T getBuilder(String path) {
        ...
        ResourceLocation outputLoc = extendWithFolder(path.contains(":") ? ResourceLocation.m_338530_(path) : ResourceLocation.m_339182_(modid, path));
    ...
    private ResourceLocation extendWithFolder(ResourceLocation rl) {
        ...
        return rl.m_246208_(folder + '/');
    }

    public ResourceLocation modLoc(String name) {
        return ResourceLocation.m_339182_(modid, name);
    }

    public ResourceLocation mcLoc(String name) {
        return ResourceLocation.m_338530_(name);
    }
     ...
     */
    public T nested() {
        return factory.apply(ResourceLocation.m_339182_("dummy",  "dummy"));
    }
    ...
    protected CompletableFuture<?> generateAll(CachedOutput cache) {
        ...
        for (T model : this.generatedModels.values()) {
            ...
            futures[i++] = DataProvider.m_253162_(cache, model.toJson(), target);
        }
    ...
    protected Path getPath(T model) {
        ...
        return this.output.m_247566_(PackOutput.Target.RESOURCE_PACK).resolve(loc.m_135827_()).resolve("models").resolve(loc.m_135815_() + ".json");
    }
}