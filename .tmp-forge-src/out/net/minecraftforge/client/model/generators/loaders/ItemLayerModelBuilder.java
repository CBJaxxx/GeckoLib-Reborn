...
{
    private static final ResourceLocation NAME = ResourceLocation.m_339182_("forge", "item_layers");
    ...
    public ItemLayerModelBuilder<T> renderType(String renderType, int... layers)
    {
        ...
        if (renderType.contains(":"))
            asLoc = ResourceLocation.m_338530_(renderType);
        else
            asLoc = parent.getLocation().m_247449_(renderType);
    ...
    public ItemLayerModelBuilder<T> renderType(String renderType, String renderTypeFast, int... layers)
    {
        ...
        if (renderTypeFast.contains(":"))
            asLocFast = ResourceLocation.m_338530_(renderTypeFast);
        else
            asLocFast = parent.getLocation().m_247449_(renderTypeFast);
