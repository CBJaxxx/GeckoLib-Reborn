...
public final class DataPackRegistriesHooks {
    ...
    static <T> void addRegistryCodec(DataPackRegistryEvent.DataPackRegistryData<T> data) {
        ...
        if (data.networkCodec() != null) {
            NETWORKABLE_REGISTRIES.add(loaderData.f_243794_());
            SYNCHRONIZED_REGISTRIES_CUSTOM.add(loaderData.f_243794_());
            SYNCHRONIZED_REGISTRIES.add(new RegistryDataLoader.RegistryData<>(loaderData.f_243794_(), data.networkCodec(), false));
        }
    }
