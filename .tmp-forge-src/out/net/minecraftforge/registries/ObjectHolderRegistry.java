...
public class ObjectHolderRegistry
{
            ...
            String value, boolean isClass, boolean extractFromValue)
    {
        ...
        if (isClass)
        {
            scanClassForFields(classModIds, type, ResourceLocation.m_338530_(registryName), registryClass, value, clazz, extractFromValue);
        }
        else
        {
            if (value.indexOf(':') == -1)
            ...
            try
            {
                ...
                ObjectHolderRef ref = ObjectHolderRef.create(ResourceLocation.m_338530_(registryName), f, value, extractFromValue);
                if (ref != null)
                    addHandler(ref);
            }
            ...
            Type targetClass, Object declaration)
    {
        if (registryName != null)
            return ResourceLocation.m_338530_(registryName);
